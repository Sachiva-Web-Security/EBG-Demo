...
export default function EventsPage(){
 return <main className={styles.page}>
  <header className={styles.header}>
   ...
   <nav><Link href="/#about">About</Link><Link href="/membership">Membership</Link><Link href="/sectors">Sectors</Link><Link href="/events">Events</Link><Link href="/#publications">Position Papers</Link><Link href="/contact">Contact</Link></nav>
